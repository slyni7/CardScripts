...
function s.onfil22(c)
	return c:IsSetCard("라일락") and c:IsType(TYPE_TRAP) and c:IsAbleToGrave() and not c:IsCode(id)
end
function s.ocon21(e)
	...
	local b2=Duel.IEMCard(s.onfil22,tp,"D",0,1,nil)
...
function s.oop21(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif op==2 then
		...
		local g=Duel.SMCard(tp,s.onfil22,tp,"D",0,1,1,nil)
		if #g>0 then
