...
function s.tfil5(c,e,tp)
	return c:IsSetCard("은하린") and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
function s.tar5(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		return Duel.IETarget(s.tfil5,tp,"G",0,1,nil,e,tp) and Duel.GetLocCount(tp,"M")>0
	end
