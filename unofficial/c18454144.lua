...
function s.onfil21(c)
	return c:IsSetCard("라일락") and c:IsType(TYPE_TRAP) and c:IsAbleToDeck() and not c:IsCode(id)
end
function s.ocon21(e)
	...
	local b1=Duel.IsPlayerCanDraw(tp,1) and Duel.IEMCard(s.onfil21,tp,"HO",0,1,nil)
	local b2=true
