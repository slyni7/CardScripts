...
if YGOPRO_VERSION~="Percy/EDO" then
	...
	pcall(Duel.LoadScript,"expansions/script/proc_xyz_koishi.lua")
end
pcall(Duel.LoadScript,"expansions/script/proc_equation.lua")
...
pcall(Duel.LoadScript,"expansions/script/YuL.lua")
--pcall(Duel.LoadScript,"expansions/script/cyan.lua")
pcall(Duel.LoadScript,"expansions/script/Rune.lua")
pcall(Duel.LoadScript,"expansions/script/hebi.lua")
pcall(Duel.LoadScript,"expansions/script/cirukiru9.lua")
