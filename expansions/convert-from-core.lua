Duel.LoadScript("proc_fusionex.lua")
Duel.LoadScript("proc_linkex.lua")
Duel.LoadScript("proc_ritualex.lua")
Duel.LoadScript("proc_synchroex.lua")
Duel.LoadScript("proc_xyzex.lua")
